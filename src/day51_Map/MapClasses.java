...
public class MapClasses {
    public static void main(String[] args) {
        ...
        Map<Integer, String> treeMap = new TreeMap<>();//key can not be null,value can be null or duplicated
        ...
        Map<Integer, String> hashtable = new Hashtable<>();//key abd value can not be null
