...
public class GreadCulculator {
    public static void main(String[] args) {

        ArrayList<Integer>  scores = new ArrayList<>();
        scores.addAll( Arrays.asList(100, 90, 75, 85, 65, 85, 55, 45, 73, 73, 35, 47));

        ArrayList<Integer> greadOfA = new ArrayList<>(scores);

        greadOfA.removeIf( p-> !(p >= 90 && p <=100) );

        System.out.println(greadOfA);
        ...
        System.out.println("total number of A:" +greadOfA.size());
